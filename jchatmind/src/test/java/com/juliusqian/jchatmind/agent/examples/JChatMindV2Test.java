package com.juliusqian.jchatmind.agent.examples;

import com.juliusqian.jchatmind.agent.tools.test.CityTool;
import com.juliusqian.jchatmind.agent.tools.test.DateTool;
import com.juliusqian.jchatmind.agent.tools.test.WeatherTool;
 ...
 */
@SpringBootTest
@Disabled("Requires live model credentials and external AI access")
